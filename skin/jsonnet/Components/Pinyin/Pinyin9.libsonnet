      ...
      VStack: {
        subviews: [
          ...
          },
          {
            HStack: {
              subviews: [
                { Cell: pinyin9Buttons.latinSymbolButton.name, },
                { Cell: pinyin9Buttons.spaceButton.name, },
                { Cell: commonButtons.gotoPinyin26Button.name, },
              ],
            },
          },
        ],
...
local newKeyLayout(isDark=false, isPortrait=false, extraParams={}) =
  ...
  + basicStyle.newSystemButton(
    pinyin9Buttons.latinSymbolButton.name,
    isDark,
    pinyin9Buttons.latinSymbolButton.params +
    {
  ...
  + basicStyle.newSystemButton(
    commonButtons.gotoPinyin26Button.name,
    isDark, commonButtons.gotoPinyin26Button.params +
    {
      size: { width: { percentage: 0.2 } },
    }
  )
